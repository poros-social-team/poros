...
insert into `poros`.`users` (`uname`,`upwd`,`urealname`,`uaite`,`utime`) values('sunfc', '9f0f2cb85019b27e','sunfc','sunfc', CURRENT_TIMESTAMP);

insert into `poros`.`usersinfo` (`uid`)  select `uid` from `poros`.`users` where uname='sunfc';