...
$("#fanwei").bind("change", function() {
		...
		if ($("#fanwei").val() == "follow") {
			search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=follow');
		} else if ($("#fanwei").val() == "fans") {
			search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=fans');
		} else if ($("#fanwei").val() == "followtwo") {
			search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=followtwo');
		} else if ($("#fanwei").val() == "fanstwo") {
			search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=fanstwo');
		} else if ($("#fanwei").val() == "all") {
			search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0');
		} */
		location.reload();
	})
	$("#jiazaianniu").on({
		click : function() {
			if ($(this).html().trim() == "点击加载更多") {
				if ($("#fanwei").val() == "follow") {
					search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=follow');
				} else if ($("#fanwei").val() == "fans") {
					search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=fans');
				} else if ($("#fanwei").val() == "followtwo") {
					search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=followtwo');
				} else if ($("#fanwei").val() == "fanstwo") {
					search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=fanstwo');
				} else {
					search('/Poros/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length);
				}
			}
		}
	});
