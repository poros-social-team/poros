...
<body>
		...
		<div>
			...
			<!-- <div>
				<input type="text" class="search" id="search"
					placeholder="搜索poros用户" /><img src="img/select.png" class="sea" />
			</div> -->
		</div>
	</div>
	<!-- end 导航栏 -->
	<div id="body">
		<div id="welcome">
			<span><h1>欢迎使用 poros。</h1></span> <span class="link">联系你的好友和更多精彩。获取你感兴趣的实时更新。并通过每个视角观看事件实时呈现。</span>
		</div>
		<!-- 样图 -->
		<ul id="tu">
		...
		<div id="rigest">
			<div class="newcomer" style="font-weight: bold;color:black;">
				新来poros？<span style="color: #666;font-weight: bold">注册</span>
			</div>
